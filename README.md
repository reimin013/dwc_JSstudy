...
- 開始日 4月10日
- 終了日 4月11日
- 成果物 Railsアプリケーションを作成して、jQeueryを実装. 作成したRailsアプリケーションはブランチ'JS_chapter13'に格納.
- 疑問 [Bookers3]にjQueryを使って文字の色を変えようとしたが上手くいかない、なぜか？⇒ 4/11時点 コードを、テンプレートの説明文の上では下に記述したことで解決.